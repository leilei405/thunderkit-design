...
describe('test Alert Component', () => {
  it('should render the correct default Alert', () => {
    ...
    expect(container.querySelector('.thunderkit-alert')).toHaveClass('thunderkit-alert-default')
  ...
  it('should render the correct Alert based on different type and description', () => {
    ...
    expect(container.querySelector('.thunderkit-alert')).toHaveClass('thunderkit-alert-success')
